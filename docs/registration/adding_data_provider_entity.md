...
Following are the steps to register an organization on the platform.

**Step 1:** Click on the **Want to become a Data Provider?** button on your dashboard.  
![Accessing Join Data Provider Entity Option from the dashboard](images/access_join_organisation.png)  
*Accessing Want to become a Data Provider? Option from the dashboard*
...
![Option to Add Data Provider Entity when not found in search](images/join_organisation.png)  
...
1. **<u>User Details:</u>** Fill your profile (Job title, Employee ID, etc.)
...
*Data Provider Entity Registration Form—Organisation Manager Details*

![Data Provider Entity Registration Form - Organisation Details](images/organisation_detail.png)  
*Data Provider Entity Registration Form—Organisation Details*

![Data Provider Entity Registration Form - Upload Organisation Documents](images/upload_organisation_doc.png)  
*Data Provider Entity Registration Form—Upload Organisation Documents*
